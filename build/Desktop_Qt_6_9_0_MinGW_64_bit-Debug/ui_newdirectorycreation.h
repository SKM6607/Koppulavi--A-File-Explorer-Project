...
public:
    ...
    void setupUi(QDialog *newDirectoryCreation)
    {
        ...
        widget = new QWidget(newDirectoryCreation);
        widget->setObjectName("widget");
        widget->setGeometry(QRect(30, 80, 371, 81));
    ...
    void retranslateUi(QDialog *newDirectoryCreation)
    {
        ...
        label->setText(QCoreApplication::translate("newDirectoryCreation", "Enter the Directory Name", nullptr));
