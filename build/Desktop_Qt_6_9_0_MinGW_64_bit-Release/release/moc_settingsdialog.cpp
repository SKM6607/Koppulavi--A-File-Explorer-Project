...
template <> constexpr inline auto settingsDialog::qt_create_metaobjectdata<qt_meta_tag_ZN14settingsDialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "settingsDialog",
        "on_defFolderLocationRadio_clicked",
        "",
        "checked",
        "on_confirmdfLocationButton_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_defFolderLocationRadio_clicked'
        QtMocHelpers::SlotData<void(bool)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Bool, 3 },
        }}),
        // Slot 'on_confirmdfLocationButton_clicked'
...
void settingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_defFolderLocationRadio_clicked((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->on_confirmdfLocationButton_clicked(); break;
        default: ;
        }
    }
}
